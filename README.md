...
- [Architecture](docs/ARCHITECTURE) → Explains the MVC structure, folder roles, and internal flow.
- [API Reference](docs/API_REFERENCE) → Endpoints, request/response examples, and usage flow.
